...
{
    std::string menuTitle = settings_show_bread_crumbs_bool ? "Main > Misc > Wav Player" : "Wav Player";

    g_Menu->AddSubmenu("RageMenu", menuTitle, Submenu_wav_player, submenuPriority, [](Submenu* sub) {
