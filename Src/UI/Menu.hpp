...
#define BUILD_1491_COMPATIBLE 0 // If true, the menu will be compatible with game version <= 1491.18
#define BUILD_132_COMPATIBLE 0 // If true, the menu will be compatible with game version <= 1.32
...
public:
	...
	// Key rebinding
	int GetVirtualKeyFromString(const std::string& keyName);
