#include "wav_player_default_states.h"

#include <thread>

std::atomic<bool> wavplayer_loop_bool = false;

bool wavplayer_loop_bool_value = wavplayer_loop_bool.load();

// Vectors

std::vector<std::string> volumeOptionVector = {
